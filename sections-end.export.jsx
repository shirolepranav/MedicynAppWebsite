...
function Gallery() {
  const cards = [
  { src: window.__resources.screenHome, label: "Home", tag: "Light mode" },
  { src: window.__resources.screenRecordsDark, label: "All Records", tag: "Dark mode" },
  { src: window.__resources.screenMedication, label: "Medication detail", tag: "Light mode" },
  { src: window.__resources.screenRecordsGridDark, label: "Categories", tag: "Dark mode" },
  { src: window.__resources.screenAnalytics1, label: "Adherence", tag: "Analytics" },
  { src: window.__resources.screenAnalytics2, label: "Frequency", tag: "Analytics" }];
