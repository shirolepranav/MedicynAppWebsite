...
function Story() {
  const panels = [
  {
    ...
    phone: window.__resources.screenAnalytics1
  },
  {
    ...
    phone: window.__resources.screenFeature01
  },
  {
    ...
    phone: window.__resources.screenEmergency
  },
  {
    ...
    phone: window.__resources.screenAnalytics2
  }];
...
function Features() {
  ...
  { icon: "lab", title: "Lab reports", body: "Results with reference ranges, trended over time." },
  ...
  { icon: "emergency", tone: "rose", title: "Emergency card", body: "Critical info, accessible without unlocking your phone." },
