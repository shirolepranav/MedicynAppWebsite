  ...
  return (
    <nav className={`nav ${scrolled ? "scrolled" : ""}`}>
      <a href="#top" className="nav-brand">
        <img src={window.__resources.logo} alt="" style={{ width: "40px" }} />
        <span>Medicyn</span>
      </a>
...
No cloud. No accounts. No tracking. Just your records, organized the way they should have been all along.
  ...
  <div className="hero-phones">
      <div className="float-y" style={{ transform: "translateY(40px)" }}>
        <Phone src={window.__resources.screenRecordsGridDark} size="sm" />
      </div>
      <div>
        <Phone src={window.__resources.screenHome} size="md" />
      </div>
      <div className="float-y-delay" style={{ transform: "translateY(40px)" }}>
        <Phone src={window.__resources.screenMedication} size="sm" />
      </div>
    </div> :
  layout === "split" ?
  <div className="hero-phones" style={{ position: "relative", display: "flex", justifyContent: "center" }}>
      <div className="phone-stack">
        <Phone src={window.__resources.screenRecordsDark} size="sm" className="phone-back float-y-delay" />
        <Phone src={window.__resources.screenHome} size="md" className="phone-front float-y" />
      </div>
    </div> :
  ...
  <div className="hero-phones">
      <div className="phone-stack" style={{ position: "relative", display: "flex", justifyContent: "center" }}>
        <Phone src={window.__resources.screenRecordsDark} size="sm" className="phone-back float-y-delay" />
        <Phone src={window.__resources.screenHome} size="md" className="phone-front float-y" />
        <Phone src={window.__resources.screenMedication} size="sm" className="phone-back-r float-y" />
      </div>
    </div>;
